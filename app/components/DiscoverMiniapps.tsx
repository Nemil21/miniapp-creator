...
export function DiscoverMiniapps({
  ...
  return (
    <Table className="[&_td]:align-top text-xs">
      <TableHeader>
        <TableRow>
          <TableHead className="text-gray-600">Miniapp</TableHead>
            ...
            <TableRow key={project.id}>
              <TableCell>
                <div className="flex items-center gap-2">
                  ...
                  <div
                    className={`w-7 h-7 rounded-lg bg-gradient-to-br from-purple-500 to-indigo-500 flex items-center justify-center text-white text-xs font-semibold flex-shrink-0 fallback-initial ${
              ...
              <TableCell>
                <span className="text-[11px] text-nowrap text-gray-500">
